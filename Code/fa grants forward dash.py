...
def read_data(): 
    ...
    return pop_30_jun, budget_grants, out_columns, nsw_grants_base, vic_grants_base, qld_grants_base, sa_grants_base, wa_grants_base, tas_grants_base, nt_grants_base
...
def simulate(per_capita_minimum, per_capita_minimum_base):
    ...
    pop_30_jun, budget_grants, out_columns, nsw_grants_base, vic_grants_base, qld_grants_base, sa_grants_base, wa_grants_base, tas_grants_base, nt_grants_base = read_data()
